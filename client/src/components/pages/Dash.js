        ...
        <div className='dashShell' >
            <div className='navBox'>
                ...
                <div className='dashMenu'>
                    ...
                    <br /><br />
                    <RouterLink className='dashItem' to='/stories'>Stories</RouterLink>
                    <br /><br />
            ...
            <Image className='dash420' src={FourTwenty} alt='...' />
                <div className='dashBody'>
                    ...
                    <h2>In all my years I have learned that marijuana creates its own community anywhere it can be found. A community based in chill and always looking to talk about its favorite topic, weed. I have found there aren't many online places to just talk about weed while also having some cool opportunites, like to catalog all your THC sources in one spot, to tell your stories or to see what the reviews for the newest strain is. Hopefully, this site will give us stoners a platform for community. As always be cool to each other and this could really grow into a big deal.</h2>
                    <h2>Here is your place to not only talk about weed but review it, ruminate on it, learn about it and to just gather info. Also, this is a place to chat about the user experience. Tell us what you did and how you felt while on some great edibles or how hilarious a movie was with some high-end silly weed or how the sweet vapors made your concert experience that much sweeter. </h2>
